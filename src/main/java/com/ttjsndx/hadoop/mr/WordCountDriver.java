...
public class WordCountDriver {
    public static void main(String[] args) throws Exception{
        ...
        FileInputFormat.setInputPaths(job,"D:/hadoopDateSpace/wordcount/input");
        FileOutputFormat.setOutputPath(job,new Path("D:\\hadoopDateSpace\\wordcount\\output"));
